    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOpenGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CoreConfig coreConfig = new CoreConfig.Builder(GalleryFinalActivity.this, imageLoader, themeConfig)
                ...
                ActionSheet.createBuilder(GalleryFinalActivity.this, getSupportFragmentManager())
                                ...
                                switch (index) {
                                    ...
                                    case 2:
                                        if (new File(path).exists()) {
                                            ...
                                            Toast.makeText(GalleryFinalActivity.this, "图片不存在", Toast.LENGTH_SHORT).show();
                                        }
                                        break;
                                    case 3:
                                        if (new File(path).exists()) {
